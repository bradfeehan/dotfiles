...
alias zaws='aws-vault-exec-wrapper aws-okta aws'
alias zsm='aws-vault-exec-wrapper aws-okta "bundle exec stack_master"'
alias awsv='aws-vault-exec-wrapper aws-vault aws'
