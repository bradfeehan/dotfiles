# Disable p10k if composer is running in no-interaction mode (agent mode)
if [[ "${COMPOSER_NO_INTERACTION:-0}" -ne 1 ]]; then
  source "${repo_root}/submodules/romkatv/powerlevel10k/powerlevel10k.zsh-theme"

  # Generated by Powerlevel10k configuration wizard on 2020-01-02 at 19:34 AEDT.
  ...
  () {
    ...
    typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION='${P9K_VISUAL_IDENTIFIER// }'
    ...
    typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
        ...
        'docker-desktop/default' LOCAL
        '*'       DEFAULT)
    typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=134
    # typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⭐'

    # Set some shorthand for when we're using docker-desktop (will show Docker icon + desktop icon)
    typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_VISUAL_IDENTIFIER_EXPANSION=
    typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_CONTENT_EXPANSION=
